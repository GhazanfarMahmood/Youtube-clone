      ...
      {currentPlaying && currentPlaying?.videoId === id && (
        <div className="max-h-screen overflow-hidden">
          ...
          <div className="flex w-full" style={{ height: "92.5vh" }}>
            <div className="flex y-10 gap-x-5 p-7 mx-20 mr-0 w-full overflow-auto">
              <div style={{ maxWidth: "800px" }}>
                <div>
                  <iframe src={`https://www.youtube.com/embed/${id}?autoplay=1`} frameBorder="0" width="800"
                    height="502" allowFullScreen title="Youtube video player" allow="accelerometer; autoplay; clipboard-white; encrypted-media; gyroscope; "></iframe>
                  <div className="mt-5">
